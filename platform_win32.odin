...
window_proc :: proc "std" (hwnd: win32.Hwnd, msg: u32, wparam: win32.Wparam, lparam: win32.Lparam) -> win32.Lresult {
...
main :: proc() {
  ...
  window := win32.create_window_ex_a(
    0, WIN32_CLASS_NAME, "odin-lang hello winapi", win32.WS_OVERLAPPEDWINDOW | win32.WS_VISIBLE,
    win32.CW_USEDEFAULT, win32.CW_USEDEFAULT, wsize.right - wsize.left, wsize.bottom - wsize.top,
    nil, nil, win32.Hinstance(hinstance), nil,
  )
  if window == nil {
